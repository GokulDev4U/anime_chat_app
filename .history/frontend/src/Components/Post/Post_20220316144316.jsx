...
import { addCommentOnPost, deletePost, likePost, myPosts, updateCaption } from '../../Actions/Post';
import { getPostOfFollowing, getUserPosts, loadUser } from '../../Actions/User';
import User from '../User/User';
import CommentCard from '../CommentCard/CommentCard';

const Post = ({ postId, caption, postImage, likes = [], comments = [], ownerImage, ownerName, ownerId, isDelete = false, isAccount = false, tab = "home" }) => {
      ...
      <Dialog open={captionToggle} onClose={() => setCaptionToggle(!captionToggle)}>
        <div className="DialogBox">
          ...
          <form className='commentForm' onSubmit={updateCaptionHandler}>
            <input type="text" placeholder="Caption Comment Here..." value={captionValue} onChange={(e) => setCaptionValue(e.target.value)} required />
