          ...
          <div className="DialogBox">
            ...
            </form>
            {
              ...
              comments.map(comment => (
                <CommentCard key={comment._id} comment={comment} userId={comment.user._id} name={comment.user.name} avatar={comment.user.avatar.url} commentId={comment.comment} postId={comment.}/>)) 
